...
- [ ] T7: 실제 키움 일봉 연동 백테스트
  ...
  - 진행: STEP 07A 일봉 조회기, STEP 07B RESCUE, STEP 07C FACTOR fixture 구현·테스트 완료. STEP 07D 기준일 계약 구현·42개 테스트·독립 리뷰 완료, 로컬 커밋 `b0c2a24f45deb0b38dcf301a026b82cfd15da70d` 생성. Docker push는 HTTPS 인증 오류로 차단되어 원격 SHA 대기. 상세는 `docs/AUTOMATION-STEP-07D-RESULTS.md`.
  - 남음: Windows에서 STEP 07D 브랜치 push 후 원격 SHA 확인, fixture 밖 실제 Kiwoom 응답·페이지네이션·가격부호·휴장일 동작 확인. ORB/BULL_FLAG 및 portfolio recommender는 규칙/계약 미정의로 fail-closed 상태이며 별도 설계 필요.
